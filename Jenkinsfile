   ...
   stage('Deploy Artifacts to Production') {
            ...
            steps {
                  sshagent(['ssh_keys']) {
                        ...
                        sh "ssh -o StrictHostKeyChecking=no ec2-user@54.179.249.90 -C \"sudo kubectl replace -f create-k8s-deployment.yaml\""
                        sh "ssh -o StrictHostKeyChecking=no ec2-user@54.179.249.90 -C \"sudo kubectl replace -f nodePort.yaml\""
